                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Clientes
                                <a href="{{url('admin/banner/create')}}" class="float-right btn btn-success btn-sm">Agregar Nuevo</a>
                            </h6>
                        </div>
                        <div class="card-body">
...
<script>
    function openEliminarModal(id) {
        $('#eliminarProductoBtn').attr('href', '{{ url("admin/banner") }}/' + id + '/delete');

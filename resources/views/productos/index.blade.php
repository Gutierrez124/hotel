...
<!-- Page Heading -->
<h1 class="h3 mb-2 text-gray-800">Todos los Productos</h1>


<!-- DataTales Example -->
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Todos los Productos
            <a href="{{url('/admin/productos/create')}}" class="float-right btn-primary btn-sm">Agregar nuevo</a>
        </h6>
    </div>
    <div class="card-body">
            ...
            <table class="table table-bordered text-center" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$d->stock}}</td>
                        <td>
                            <a href="{{url('admin/productos/'.$d->id.'/edit')}}" class="btn btn-success btn-sm"><i class="fa fa-edit"></i></a>
...
<script src="/vendor/datatables/jquery.dataTables.min.js"></script>
    ...
    function openEliminarModal(id) {
        $('#eliminarProductoBtn').attr('href', '{{ url("admin/productos") }}/' + id + '/delete');
